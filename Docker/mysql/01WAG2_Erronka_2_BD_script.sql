...
--
DROP TABLE IF EXISTS produktu_mugimendua;
DROP TABLE IF EXISTS kolore_historiala;
DROP TABLE IF EXISTS bezero_fitxa;
DROP TABLE IF EXISTS produktua;
DROP TABLE IF EXISTS kategoria;
DROP TABLE IF EXISTS ticket_lerroa;
DROP TABLE IF EXISTS tratamendua;
DROP TABLE IF EXISTS hitzordua;
DROP TABLE IF EXISTS materiala_erabili;
DROP TABLE IF EXISTS materiala;
DROP TABLE IF EXISTS txanda;
