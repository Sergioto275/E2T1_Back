...
class hitzordu_controller extends Controller
{
    ...
    public function erakutzi(){
        $datos = hitzordu_model::where(function ($query) {
    ...
    public function insert(Request $request){
        ...
        $eserlekua++;
        $data=["eserlekua"=>$eserlekua,"data"=>$datos["data"],"hasiera_ordua"=>$datos["hasOrdua"],"amaiera_ordua"=>$datos["amaOrdua"],"izena"=>$datos["izena"],"telefonoa"=>$datos["telefonoa"],"deskribapena"=>$datos["deskribapena"],"etxekoa"=>$datos["etxekoa"]];
    ...
    {
        $count = hitzordu_model::where('data', '=', $data)
    ...
    public function update(Request $request){
        ...
        if(!$belajar){
            ...
            hitzordu_model::where('id', $datos['id'])->update(array('data'=>$datos['data'],'hasiera_ordua'=>$datos['hasiera_ordua'],'amaiera_ordua'=>$datos['amaiera_ordua'],'izena'=>$datos['izena'],'telefonoa'=>$datos['telefonoa'],'deskribapena'=>$datos['deskribapena'],'etxekoa'=>$datos['etxekoa'], "eguneratze_data" => $eguneratze_data));
            return response('', 202);
        }
    }
    ...
    public function delete(Request $request){
        ...
        if(!$belajar){
            ...
            hitzordu_model::where('id', $datos['id'])->update(array('ezabatze_data'=>$ezabatze_data));
            return response('', 200);
        }
    }
