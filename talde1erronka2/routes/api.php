...
Route::post("/taldeakdelete","App\Http\Controllers\\talde_controller@taldea_delete");
Route::post("/taldeakeguneratu","App\Http\Controllers\\talde_controller@taldea_update");
